...
namespace XG.Comm.Core
{
    ...
    /// </summary>
    public abstract class CustomFixedHeaderByteBlockDataHandlingAdapter<TFixedHeaderRequestInfo> : CustomDataHandlingAdapter<TFixedHeaderRequestInfo> where TFixedHeaderRequestInfo : class, IFixedHeaderByteBlockRequestInfo
    {
        /// <summary>
        /// 固定包头的长度。
        /// </summary>
