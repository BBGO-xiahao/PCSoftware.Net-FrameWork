...
namespace XG.Com.Comm
{
    ...
    public class TcpClientBase : BaseSocket, ITcpClient
    {
        ...
        protected virtual void OnConnected(ConnectedEventArgs e)
        {
            ...
            {
                LogUtil.GetInstance().Log($"在事件{nameof(this.Connected)}中发生错误。",ex);
            }
        }
        ...
        protected virtual void OnConnecting(ConnectingEventArgs e)
        {
            ...
            {
                LogUtil.GetInstance().Log($"在事件{nameof(this.OnConnecting)}中发生错误。", ex);
        ...
        protected virtual void OnDisconnected(DisconnectEventArgs e)
        {
            ...
            {
                LogUtil.GetInstance().Log($"在事件{nameof(this.Disconnected)}中发生错误。", ex);
            }
        }
        ...
        protected virtual void OnDisconnecting(DisconnectEventArgs e)
        {
            ...
            {
                LogUtil.GetInstance().Log($"在事件{nameof(this.Disconnecting)}中发生错误。", ex);
        ...
        private void HandleBuffer(ByteBlock byteBlock)
        {
            try
            {
                ...
                {
                    LogUtil.GetInstance().Log(TouchSocketResource.NullDataAdapter.GetDescription());
                    return;
                }
            ...
            {
                LogUtil.GetInstance().Log($"在处理数据时发生错误", ex);
            }
            finally
            {
                byteBlock.Dispose();
